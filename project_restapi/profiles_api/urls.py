...
from .views import my_api,api_viewsets,userprofile_viewset,user_login_apiview,userprofile_feed_viewset
...
router.register('profile_feed',userprofile_feed_viewset)
